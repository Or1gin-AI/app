export const en = {
  ...
  plan: {
    ...
    downgradeDesc: 'The downgrade will take effect after your current plan expires on {date}.',
    confirmDowngrade: 'Confirm Downgrade',
    // Done
    doneTitle: 'Success',
    doneDesc: 'You have been switched to {plan}. Thank you!',
    doneDowngradeDesc: 'Downgrade scheduled. It will take effect after {date}.',
    ok: 'OK',
  },
  titlebar: {
    networkOk: 'Connected',
